...
- **Вход через tdata (Telegram Desktop):** укажите путь к папке `tdata` (например, `%APPDATA%\Telegram Desktop\tdata`).  
...
За полгода использования ни одного бана не зафиксировано.
...
Спасибо, что нашёлся добрый человек, который помог с Claude Code!  
