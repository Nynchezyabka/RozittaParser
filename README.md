...
- **Вход через tdata (Telegram Desktop):** 1. Закройте открытый Telegram Desktop dj избежание конфликтов сессий. 2. Укажите путь к папке `tdata` (например, `%APPDATA%\Telegram Desktop\tdata`).  
